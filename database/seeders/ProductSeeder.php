    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            [
                ...
                'category_id' => $categoryIds[array_rand($categoryIds)], // Lấy ngẫu nhiên category_id hợp lệ // ID của danh mục Nước uống
                'view' => 200,
            ...
            [
                ...
                'category_id' => $categoryIds[array_rand($categoryIds)], // Lấy ngẫu nhiên category_id hợp lệ // ID của danh mục Món khai vị
                'view' => 50,
            ...
            [
                ...
                'category_id' => $categoryIds[array_rand($categoryIds)], // Lấy ngẫu nhiên category_id hợp lệ // ID của danh mục Món tráng miệng
                'view' => 100,
