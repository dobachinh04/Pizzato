                                                ...
                                                <div class="row g-3 mb-0 align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <a href="{{ route('admin.products.create') }}"
                                                            class="button btn btn-success"> <i
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    ...
                                                    <a href="{{ route('admin.products.index') }}"
                                                        class="text-decoration-underline">Xem Tât Cả Sản Phẩm</a>
                                                </div>
                                                <style>
                                                    .custom-yellow {
                                                        color: yellow;
                                            ...
                                            <div class="d-flex align-items-end justify-content-between mt-4">
                                                <div>
                                                    ...
                                                    <a href="{{ route('admin.orders.index') }}"
                                                        class="text-decoration-underline">Xem Tất Cả Đơn Hàng</a>
                                                </div>
                                                <div class="avatar-sm flex-shrink-0">
                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    <div class="card card-height-100">
                                        ...
                                        <div class="card-body">
                                            <table id="pending-order-datatable"
                                                    ...
                                                    @foreach ($orderOvers as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="badge bg-secondary">{{ $item->payment_status }}</span>
                                                                @endif
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @else
                                                                    <span
                                                                        class="badge bg-secondary">{{ $item->order_status }}</span>
                                                                @endif
                                                            </td>
                                                            <td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="notifyForm" class="needs-validation"
                                                                action="{{ route('admin.notify.order') }}" method="POST"
                                                                novalidate>
                                                                @csrf
                                            ...
                                            <div class="flex-shrink-0">
                                                <button type="button" class="btn btn-soft-info btn-sm">
                                                    <i class="ri-file-list-3-line align-middle"><a
                                                            href="{{ route('admin.orders.index') }}" class="ms-1">Xem
                                                            Tất Cả Đơn Hàng</a></i>
                                                </button>
                                            </div>
                                        </div> <!-- .card-->
                        ...
                        <div class="layout-rightside">
                            <div class="card h-100 rounded-0">
                                <div class="card-body p-0">
                                    ...
                                    <div class="p-3">
                                        <h6 class="text-muted mb-3 text-uppercase fw-semibold">Trung Bình Đánh giá</h6>
                                        <div class="bg-light px-3 py-2 rounded-2 mb-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <h6 class="mb-0">{{ round($averageRating, 1) }}/5 Sao</h6>
                                                </div>
                                            </div>
                                        </div>
